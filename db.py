...
MIGRATION_STATEMENTS = [
    ...
    "ALTER TABLE giveaways ADD COLUMN IF NOT EXISTS show_caption_above_media BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE giveaways ADD COLUMN IF NOT EXISTS has_media_spoiler BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE giveaways ADD COLUMN IF NOT EXISTS link_preview_options JSONB",
